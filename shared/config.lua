...
Config.SyphonDispatchSystem = "ps-dispatch" -- Options: "cd_dispatch", "ps-dispatch", "qb-dispatch", "qb-default" (just blips) or "custom" (Custom: you must configure yourself!)
