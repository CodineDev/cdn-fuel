if Config.ElectricVehicleCharging then
    ...
    if Config.RenewedPhonePayment then
        RegisterNetEvent('cdn-fuel:client:electric:phone:PayForFuel', function(amount)
            ...
            local success = exports['qb-phone']:PhoneNotification(Lang:t("electric_phone_header"), Lang:t("phone_notification")..total, 'fas fa-bolt', '#9f0e63', "NONE", 'fas fa-check-circle', 'fas fa-times-circle')
            if success then
